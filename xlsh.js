			...
			var xlsh={
				...
				skill:{
					...
					"xlsh_暴怒1":{
						...
						filter:function (event,player){
							return player.isXlsh_c()&&game.zhu&&game.zhu.hasSkill('xlsh_暴怒');
						},
						content:function (){
							'step 0'
...
return 0;
					...
					"xlsh_繁荣1":{
						...
						filter:function (event,player){
							return !player.hasSkill('xlsh_繁荣')&&player.countCards('h')>0;
						},
						direct:true,
						content:function (){
							'step 0'
					...
					"xlsh_欲带":{
						...
						multiline:true,
						content:function(){
							targets[0].chooseToDiscard('h',2,true);
						...
						subSkill:{
							'1':{
								...
								content:function (){
									...
									player.draw();
									'step 1'
									trigger.player.chooseCard('h','请选择一张手牌作为“律”',true).set('ai',function(card){
