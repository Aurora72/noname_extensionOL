window.func=function(lib,game,ui,get,ai,_status){
	...
	lib.translate.zx_月饼='月饼';
	lib.translate.zx_月饼_info='出牌阶段，对一名角色使用，其获得随机的正面效果';
                var nyhzrlj={
                    name:'nyhzrlj',
                    connect:true,
					connectBanned:["fnyhzr福娃ol","dnyhzr大乔ol","cnyhzr嫦娥ol","ynyhzr月兔ol","lnyhzr龙骑士ol"],
                    character:{
            ...
            "snyhzr司马懿ol":["male","zhi",3,["nyhzr液态火ol","nyhzr元素转化ol"],["ext:扩展ol/Newsnyhzr司马懿.jpg","des:<li>他生于乱世，被称为有“狼顾”之相。<li>他善于奇策，多次征伐有功，曾两次率大军成功对抗诸葛亮北伐。 他还曾率领大军征伐辽东公孙渊，采用声东击西之计，出其不意包围辽东主城襄平，一举击破并斩杀辽东公孙渊，平定辽东之乱。数十年来辽东问题终于彻底解决。<li>他能文能武，无论战阵谋略还是领兵打战，都胜人一筹。<li>去世后，依然深得好评，应了那句“少有奇节，聪明多大略，博学治闻，伏膺儒教”。"]],
            ...
            "ynyhzr雅典娜ol":["female","zhi",3,["nyhzr战争惧刃ol","nyhzr圣光法球ol"],["ext:扩展ol/Newynyhzr雅典娜.jpg","des:<li>愤怒的时代结束了，在黎明尽头，诸神以犹疑的目光注视着天地中心的那扇混沌之门，那是异世界的入口，是战争的源头，是混合了信仰、破灭、黑暗、光明、绝望以及希望的所在。女神在那里放下希望信标，天空之风轻轻将历史翻过新的一页。<li>千年之后，上古时代的种种已化为发黄书页中记载的传说。人类在世界各地建立新的国家，繁衍生息。然而，随着时间的推移，原来平和温顺的人类似乎被拖入欲望的迷沼，贪婪、胆怯、卑劣、背诺……信仰缺失的人类犹如置身重重迷雾之中……<li>种种游离的、隐秘不定的迹象，将混沌之门这个早已埋没在历史尘埃中的地点重新提及。一些试图重新找寻本源的人站了出来。据说，他们得到了一位神祗的相助——那名神秘的女神有着传说一般的身世与容貌。人们被阻隔在这层传说之雾外，唯一可知的就是她有一个温柔的名字：雅典娜。"]],
            "xnyhzr西莫ol":["male","zhi",4,["nyhzr欲望灾火ol"],["ext:扩展ol/Newxnyhzr西莫.jpg","des:<li>也许是饥荒年代的一次捕食，食人魔这个名字便顽固地流传开来。那异乎寻常的外貌被添油加醋成为了食人的证明。为了清除可能的隐患因素，人类对食人魔族展开了大规模围剿，哪怕他们早已不将人类作为食物。<li>压倒性的战局令大批大批的食人魔沦为帝国的奴隶。要么毫无尊严的成为奴隶，要么成为人类狩猎的活靶。“比起战死而言，成为人类的奴隶只要听话至少衣食无忧”，这个想法一度成为食人魔族的共识。<li>生来便拥有两个脑袋的西莫很明显是个异类，无论是哪个方面。也许是两个脑袋的缘故，他对于自由的渴望比其他食人魔更加炽烈，当然，智慧与勇气也有双份。他巧妙地制造一起起收容所暴动，策划了一场又一场的游击战。人类花费了极大的精力来应付他精妙的战术却均以失败告终。食人魔族开始相信西莫将是带领他们走向光明的天选之子，是他们毕生追随的首领，与信仰。<li>然而西莫知道，为了确保族人能重新和平的生活在这片大地上，不再沦为奴隶，不再饱受战火，他将一直战斗下去，直到生命的最后一刻。"]],
            "cnyhzr丛林之子ol":["male","min",3,["nyhzr毁灭蛊箭ol","nyhzr生存本能ol"],["ext:扩展ol/Newcnyhzr丛林之子.jpg","des:<li>智慧之光并非只恩赐了文明，文明之外，人类仍可发现其它不同类别的知识。丛林之子便是其中之一，他们被称为“绿野中的守护”，对于自然的暴戾与温柔都有相当了解，他们并不完全依赖自然，而是与自然相融为一。<li>无法确定是否是炼金术师们首先发现了丛林之子，但在人类的历史遗迹中，我们随处可见他们留下的痕迹：海岛上不知名的巨石阵、金字塔下兽型的人面像，甚至还有决战之谷里难解的图腾柱。丛林之子使用来自自然但又超越自然的能量，他们从地母信仰中祈得祝福，为自由谱写誓言之歌。<li>丛林之子为森林带来了祝福。被其净化的不洁，化为可以滋润万物的雨水。也是从那时起，世界上出现了雨林。据说，常在雨林中行走的人可以听到时而传来的丛林之子的笑声……"]],
			...
			"dnyhzr妲己ol":["female","zhi",3,["nyhzr九命妖尾ol","nyhzr勾魂大法ol"],["ext:扩展ol/Newdnyhzr妲己.jpg","des:<li>瘟疫。眼眸所注视的除了死亡，还有，饥饿。女娲将一幅充满着诱惑与光辉的画卷朝前展开，小狐女的眼前掠过王国三千里繁华鼎盛的疆土，在鲜花路面的尽头，王在等她。接受命运的安排，她就可以成为世间最强帝王的王妃。<li>十年一晃，十年倾城。当初的狐女业已成为商纣最挚爱的王妃。人们叫她妲己，对她的美貌顶礼膜拜，在王国纵驰的驿道上，随处可见俗人对她的颂扬。<li>但她自己呢？她在帘幕后书空咄咄的那些年，心里一直念叨的难道不是那个叫伯邑考的聪明男子么？但她毕竟还是错过了什么。武王姬发破城的时候，她有一种摇摇欲坠的破败感，像是自己的无极塌了。长生如梦，一切终究抵不过命运的嘲弄。兵火燃尽的时候，妲己醒来。<li>女娲在等弟子的求情，但这一次她看到了不一样的光——妲己向女娲俯身下拜，然后朝着西岐的方向飞去。她不确定如何才叫爱，她只是忽然明白了，连无极都无法洗去的思念，修行又怎么能够呢……"]],
			"knyhzr卡柯ol":["male","min",4,["nyhzr宿敌之剑ol"],["ext:扩展ol/Newknyhzr卡柯.jpg","des:<li>他曾是波斯帝国高贵的王子殿下，被称为太阳之子—他那金色的短发就如他的性格一般阳光璀璨。<li>可当权谋的阴影将他笼罩，面对至亲王叔的背叛与毒杀，再璀璨的金色也会染上复仇的暗光。仅仅是一夜之间，他失去了所有的亲人、他的家园、他爱慕的女子……以及一切，而他唯一收获的，就只有仇恨。但失去权势的王子殿下，又能用怎样的手段杀死那个已经坐上至高王座的仇人呢？<li>于是，当冥府之神阿努比斯现身时，他没有丝毫犹豫地签下了代表死亡的契约。冥神的力量在他的体内充斥，他终于彻底沦为复仇的傀儡。当他手持复仇双刃割下王叔的头颅，泪水终于无可抑制的从他的眼角滑落——财富、权势和贪婪，以及最后的仇恨，让他真正的一无所有。<li>对于生命，他还有什么可以贪恋的呢？当他手握王叔的头颅，迎来冥神阿努比斯时，唯一怀念的，就是太阳光辉笼罩下亲人温柔的回望。"]],
			"anyhzr艾薇ol":["female","min",3,["nyhzr追袭ol","nyhzr射月ol"],["ext:扩展ol/Newanyhzr艾薇.jpg","des:<li>艾薇是暗月森林最美丽的精灵。可是，正是这份美丽，引来了大主祭的垂涎。为了摆脱纠缠，艾薇决定成为法定不得婚嫁的皇室神射手。<li>经过激烈的角逐，她得到精灵女王的认可，成功入选，甚至获得了专属于女性精灵射手的荣耀之名——神箭哲琴。<li>大主祭的美梦成了泡影。恼羞成怒的他决心毁掉这件自己得不到的珍宝。他勾结恶魔军团，在艾薇前往接受封赐的路上设伏偷袭。 艾薇的伙伴们在第一轮箭雨下死伤殆尽。<li>满怀悲愤的艾薇退入密林，用她冰冷的箭矢收割着恶魔的性命。企图逃走的大主祭被远远射来的一只大箭钉在树上，随后被密集的箭岚射成了蜂窝。<li>当援军赶到时，艾薇已经力竭身亡，藤弓流月静静地躺在她的脚边，她的四周是数千恶魔的尸首。"]],
			"fnyhzr福娃ol":["female","zhi",3,["nyhzr连年有余ol","nyhzr定时爆竹ol"],["ext:扩展ol/Newfnyhzr福娃.jpg"]],
			"gnyhzr关羽ol":["male","li",4,["nyhzr结义ol","nyhzr春秋刀法ol"],["ext:扩展ol/Newgnyhzr关羽.jpg"]],
			"lnyhzr李白ol":["male","min",3,["nyhzr青莲刃ol","nyhzr还鞘决ol"],["ext:扩展ol/Newlnyhzr李白.jpg"]],
			"cnyhzr嫦娥ol":["female","zhi",3,["nyhzr月之轮回ol","nyhzr月潮引力ol"],["ext:扩展ol/Newcnyhzr嫦娥.jpg"]],
			"fnyhzr服部半藏ol":["male","min",4,["nyhzr残废影刃ol"],["ext:扩展ol/Newfnyhzr服部半藏.jpg"]],
			"snyhzr神雕侠ol":["male","li",4,["nyhzr神雕ol"],["ext:扩展ol/Newsnyhzr神雕侠.jpg"]],
			"lnyhzr莱戈拉斯ol":["male","min",3,["nyhzr幻影分身ol","nyhzr神圣之箭ol"],["ext:扩展ol/Newlnyhzr莱戈拉斯.jpg"]],
			"ynyhzr月兔ol":["female","min",3,["nyhzr月之轮回ol","nyhzr月之惩罚ol"],["ext:扩展ol/Newynyhzr月兔.jpg"]],
			"anyhzr艾迪兰ol":["female","zhi",3,["nyhzr三重卡组ol","nyhzr强效魔卡ol"],["ext:扩展ol/Newanyhzr艾迪兰.jpg","des:<li>聪明可爱的艾迪兰从小就特别向往神秘又强大的魔法。国王疼爱他的女儿，寻找到一位法力高强的女巫，但是艾迪兰太想学魔法了，女巫临走留下卡牌，一去无踪。<li>宫殿外的花开了又落，顽皮的少女也长成了端庄的公主，美名远扬的艾迪兰倾倒了无数人，而邻国一位英俊不凡、谈吐高雅的王子路易斯此
遇雕兄涉险，剑指毒蟒，虽说原本是打算捉了去和邻家妹子的飞禽比试，但万万不至于插手异兽之斗死生相助。过郎皱眉思忖，感受到大雕体息，侧身抬眼凝视雕兄，时而黯然神伤时而饶有兴致。 倾体羽毛稀疏零落，褐中杂黄,爪如枯槁，不畏蟒群扩胸挺翅,张开硕大的羽翼瞪视嗔怒。世间千万珍禽异兽,未见如此意气超迈者——这是过郎初见大雕的印象，丑陋落魄容不得被蔑视，像极了幼失怙恃、生性倔强的自己。龙女迷踪，过郎心心念念的江湖失了味；饲主绝尘，灵雕心智远胜同类，无人共情。同狂，同痴，同戚，同苦，大雕既似过郎又是过郎，这人与禽相遇相知，倒是少了诸多人情世故，道尽最深的孤独。 过郎忽的把酒盅往桌上一拍，“嗯，我知道了，我救雕兄是因为需要一只坐骑来跑图！”大雕轻歪头转动眼瞳，闻言不置可否。过郎见状浅笑，缓缓又满上一杯，只为这月下不虚席，一饮而尽，眼中不见嬉意，“沉剑埋名，绿衫野屋，过郎得雕兄伴于左右，三生有幸。” 纵天地同老，幸不形单影只，不外如是。",
				"lnyhzr莱戈拉斯ol":"<li>伴随着漫长旅程的是孤寂与危险，是半兽人与食人妖的追击，是一场场可歌可泣的战役…… 当力量之源被投入火山熔浆中那刻，一切的付出都得到了回报。不过，复兴秩序的道路同样漫长，精灵王子与他的朋友们再一次踏上了重建的旅程。",
				"ynyhzr月兔ol":"<li>玉兔拥有了花瓣般温柔的心灵，这使她在窥测人心意时有着更为敏锐的触觉。情感的好恶常使人在对待他人时态度不同，但玉兔对人却不分厚薄",
			},
            skill:{
            "nyhzr仙灵伙伴ol":{
                nobracket:true,
...
//					game.awakenShow('Newsnyhzr司马懿','20','red','元素转化');
            ...
            "nyhzr泯灭水球ol":{
				...
				content:function (){
					...
					for(i=cardPileFirstCard.length-1;i>=0;i--){
						ui.cardPile.insertBefore(cardPileFirstCard[i],ui.cardPile.firstChild);
					};
				},
            },
            "nyhzr生命凋零ol":{
                ...
                subSkill:{
                    ...
                    "3333":{
                        ...
                        content:function (){
							...
							for(i=showTwoCard.length-1;i>=0;i--){
								ui.cardPile.insertBefore(showTwoCard[i],ui.cardPile.firstChild);
							};
            ...
            "nyhzr腐肉吸噬ol":{
				...
				content:function (){
					...
					for(i=event.cards.length-1;i>=0;i--){
				...
				content:function (){
					for(var i=0;i<game.players.length;i++){
						...
						if(game.players[i].classList.contains('out')){
							...
							game.players[i].removeSkill('nyhzr神圣对决ol1');
							game.log(game.players[i],'退出决斗');
						};
					};
					if(trigger.source){
						trigger.source.addSkill('nyhzr神圣对决ol0');
						if(trigger.source.storage.nyhzr神圣对决ol0==undefined) trigger.source.storage.nyhzr神圣对决ol0=0;
				...
				content:function (){
					for(var i=0;i<game.players.length;i++){
						...
						if(game.players[i].classList.contains('out')){
							...
							game.players[i].removeSkill('nyhzr神圣对决ol2');
							game.log(game.players[i],'退出决斗');
						};
					};
					if(trigger.source){
				...
				content:function (){
					for(var i=0;i<game.players.length;i++){
						...
						if(game.players[i].classList.contains('out')){
							...
							game.players[i].removeSkill('nyhzr神圣对决ol3');
							game.players[i].draw();
							game.log(game.players[i],'退出决斗');
						};
					};
            ...
            "nyhzr神圣对决ol0":{
				...
				intro:{
					content:function(storage,player){
    					return '造成的伤害+'+player.storage.nyhzr神圣对决ol0;
					},
				},
				marktext:"神",
				mark:true,
...
//					return player.num('h','shan')>0;
			...
			"_nyhzrSkillCard": {
				group: ["_nyhzrSkillCard_1", "_nyhzrSkillCard_2"],
				subSkill: {
					"1": {
						mod: {
							maxHandcard: function (player, num) {
								return num + player.countCards('h',function(card){
									return card.name.indexOf('kzol_skillCard_')!=-1;
								});
							},
						},
						trigger: {
						...
						filter: function (event, player) {
							...
							for(var i=0;i<event.cards.length;i++){
								...
								if(card.name.indexOf('kzol_skillCard_')!=-1) return true;
							};
							return false;
						},
						content: function () {
							for(var i=0;i<trigger.cards.length;i++){
								...
								if(card.name.indexOf('kzol_skillCard_')!=-1){
									if(!player.hasSkill(card.name.slice(15,card.name.length))) player.addSkill(card.name.slice(15,card.name.length));
								};
							};
						},
					},
					"2": {
						...
						filter: function (event, player) {
							...
							for(var i=0;i<event.cards.length;i++){
								var card=event.cards[i];
								if(card.name.indexOf('kzol_skillCard_')!=-1){
									if(player.countCards('h',{name:card.name})==0) return true;
								};
							};
							return false;
						},
						content: function () {
							for(var i=0;i<trigger.cards.length;i++){
								var card=trigger.cards[i];
								if(card.name.indexOf('kzol_skillCard_')!=-1){
									if(player.countCards('h',{name:card.name})==0) player.removeSkill(card.name.slice(15,card.name.length));
								};
							};
							setTimeout(function(){
								for(var i=0;i<ui.discardPile.childNodes.length;i++){
									if(ui.discardPile.childNodes[i].name.indexOf('kzol_skillCard_')!=-1) ui.discardPile.removeChild(ui.discardPile.childNodes[i]);
								};
							},750);
						},
					},
            ...
            "nyhzr三重卡组ol":{
				...
				content:function(){
					...
					for(var i in lib.card){
						if(i.indexOf('kzol_skillCard_')!=-1) list.push(i);
					};
            ...
            "nyhzr强效魔卡ol": {
            	...
            	content: function () {
            		player.changeHujia();
            		if (Math.random() <= 0.35) player.useSkill('nyhzr三重卡组ol');
            	},
            	ai: {
            		order: 0.5,
            	},
            ...
            "anyhzr艾迪兰ol":"艾迪兰",
            "nyhzr三重卡组ol":"三重卡组",
            "nyhzr三重卡组ol_info":"<span class=\"bluetext\" style=\"color:#EE7621\">被动：</span><br>回合开始时，你获得一张技能牌，每三轮限一次",
            "nyhzr强效魔卡ol":"强效魔卡",
            "nyhzr强效魔卡ol_info":"出牌阶段，你可以弃置一张技能牌并增加一点护甲，然后35%触发一次【三重卡组】技能，每回合限一次",
            "mnyhzr灭世魔星dj":"灭世魔星",
            "lnyhzr咯哩咯哩ol":"咯哩咯哩",
            ...
            "nyhzr永恒之斩ol":"永恒之斩",
            "nyhzr永恒之斩ol_info":"<span class=\"bluetext\" style=\"color:#EE7621\">被动：</span><br>当你造成伤害时，若目标体力值等于其体力上限，你取消伤害效果，然后目标失去一点体力上限若目标体力值不等于其体力上限，否则目标手牌上限-1",
            ...
            "nyhzr腐肉吸噬ol1":"腐肉吸噬",
            "nyhzr腐肉吸噬ol":"腐肉吸噬",
            "nyhzr腐肉吸噬ol_info":"<span class=\"bluetext\" style=\"color:#EE7621\">被动：</span><br>回合结束后，若你的体力值大于手牌数，你展示X张牌（X为你的体力值与手牌数的差），若其中有黑色牌，你选择恢复一点体力或摸Y张牌（Y为其中的黑牌数），若你选择的选项为摸Y张牌，下个回合的出牌阶段，你使用卡牌时，若与上次使用的卡牌花色不同，你摸一张牌，最后你将展示的牌返回牌堆",
            ...
            "nyhzr黑桃暗杀ol1":"黑桃暗杀",
            "nyhzr黑桃暗杀ol":"黑桃暗杀",
            "nyhzr黑桃暗杀ol_info":"限定技，出牌阶段，你可以将手牌的复制牌置于你的武将牌上，在接下来的30秒内，你进入潜行状态，30秒结束后，你可以对一名其他角色造成一点伤害",
            "nyhzr代天罚恶ol":"代天罚恶",
			...
			"nyhzr月之轮回ol":"月之轮回",
            "nyhzr月之轮回ol_info":"<span class=\"bluetext\" style=\"color:#EE7621\">被动：</span><br>身份模式下，每一轮的首个角色的回开始前，你展示牌堆顶的一张牌并获得之，若主公下X家为你,你摸一张牌，否则你与主公下X家交换座位(X为展示牌的点数-1)<br>每次你触发此技能时,按照月相顺序改变月相",
			...
			"nyhzr残废影刃ol_append":"<span class=\"bluetext\" style=\"color:#EE7621\">被动：</span><br>当你失去技能【残废影刃】时，你获得技能【极影】<br>极影:当你的回合结束后，你摸两张牌，然后失去此技能并获得技能【残废影刃】",
			"nyhzr极影ol":"极影",
            "nyhzr极影ol_info":"<span class=\"bluetext\" style=\"color:#EE7621\">被动：</span><br>当你的回合结束后，你摸两张牌，然后失去此技能",
			...
			"nyhzr月之惩罚ol_append":'<div class="card button fullskin noclick" style="width:75px;height:75px;"><div class="image" style="background-image: url('+lib.assetURL+'extension/扩展ol/zx_月饼.png);"></div><div class="info"><span> </span>基本</div><div class="name" data-nature="">月<br>饼<br></div></div>'+"<br>"+lib.translate.zx_月饼_info,
			},
                };
            game.import('character',function(){
                return nyhzrlj;
            });
			for (var i in nyhzrlj.character) {
				if(i=='anyhzr艾迪兰ol') continue;
				var character=nyhzrlj.character[i];
				var image='ext:扩展ol/'+get.translation(i)+'.jpg';
				for(var j=0;j<character[4].length;j++){
					if(character[4][j].indexOf('ext:扩展ol/')!=-1) image=character[4][j];
				};
				for(var j=0;j<character[3].length;j++){
					lib.card['kzol_skillCard_'+character[3][j]]={
						fullimage:true,
						type:"技能",
						image:image,
						ai:{
					...
					lib.translate['kzol_skillCard_'+character[3][j]]=nyhzrlj.translate[character[3][j]];
					lib.translate['kzol_skillCard_'+character[3][j]+'_info']='当此牌在你手牌区中，你拥有技能【'+nyhzrlj.translate[character[3][j]]+'】且你的手牌上限+1';
				};
			};
            ...
            lib.translate['nyhzrlj_character_config']='英魂之刃';
			lib.group.push('li');
			...
			//lib.help.英魂之刃="<li>概念解释<ul><li>被动：即锁定技<li>❤被动：即不可移除的锁定技</ul>";
}