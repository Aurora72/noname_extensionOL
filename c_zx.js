window.func=function(lib,game,ui,get,ai,_status){
		game.import('character',function(lib,game,ui,get,ai,_status){
			var c_zx={
				...
				connect:true,
				character:{
					"ald_ailudi":["female","shen",3,["ald_yinju"],[]],
				...
				skill:{
					...
					"_FGO_support":{
						...
						filter:function(event,player){
							...
							(player.name2!=undefined&&lib.character[player.name2]!=undefined&&lib.character[player.name2][4].contains('FGO')));
						},
						content:function(){
							game.broadcastAll(function(player){
							...
							"1":{
								...
								content:function(){
									...
									var interval=setInterval(function(){
										...
										if(sec<10) sec='0'+sec;
										player.node.FGO_condition.innerHTML='<br>存在时间：'+Math.floor(player.storage.FGO_lifeTime/60)+':'+sec;
							...
							"2":{
								...
								content:function(){
									...
									var interval=setInterval(function(){
										...
										player.node.FGO_condition.innerHTML=str+'<br>已存在'+player.storage.FGO_lifeRound+'个回合';
						...
						content:function(){
							...
							var interval=setInterval(function(){
								...
								if(player.storage.FGO_lifeTime>player.storage.FGO_shenshoudezhihui*60){
									player.popup('FGO_shenshoudezhihui');
						...
						subSkill:{
							"1":{
								...
								content:function(){
									...
									var interval=setInterval(function(){
										player.node.FGO_condition.innerHTML='<br><span style="font-weight:600;font-size:12px">受到过'+player.storage.FGO_condition_damage1+'次雷电伤害</span>';
				...
				translate:{
					...
					"ald_yinju1":"现世",
					"ald_yinju":"隐居",
					"ald_yinju_info":"锁定技，游戏开始时，你进入隐居状态，25秒后，你解除隐居状态并选择发展路线",
					"ald_zhiyu":"治愈",
					...
					"FGO_jijiehousheng_info":"当你失去装备区内的牌后，你可以定向重铸一张装备区内的牌，若如此做，你可以将定向重铸前的同名装备牌给予一名其他角色（以此法重铸武器后你将永久获得重铸前的武器技能）",
