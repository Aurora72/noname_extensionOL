	...
	game.import('character',function(lib,game,ui,get,ai,_status){
		var aljx={
				...
				"aljx_重明继焰":{
					...
					init:function (player){
						...
						for(var i=0;i<game.players.length;i++){
							...
							if(pl!=player&&pl.hasSkill('aljx_重明继焰')) pl.removeSkill('aljx_重明继焰');
						};
					},
					trigger:{
						player:"dieBefore",
			...
			translate:{
				...
				"aljx_重明继焰":"重明继焰",
				"aljx_重明继焰_info":"该技能只能在场上存在一个。当你死亡时，你可以将你的武将牌移出游戏并给予一名其他角色一张【重明】，当其回合结束后，你将武将牌移回游戏内，若其手中没有你给予的【重明】，你立即死亡，否则其弃置之，然后你将体力回复至体力上限并执行一个额外的回合（失去的【重明】会转化为【桃】）",
				"aljx_重明继焰_append":'<div class="card button fullimage equip7 noclick" style="background-image: url('+lib.assetURL+'extension/扩展ol/aljx_传奇朱雀.jpg);background-size: cover;width:70px;height:70px;"><div class="image"></div><div class="info"><span> </span>基本</div><div class="name" data-nature="">重<br>明<br></div></div>'+"<br>"+lib.translate.aljx_重明_info,
				"aljx_玉石俱焚":"玉石俱焚",
