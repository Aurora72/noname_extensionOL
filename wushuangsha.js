            ...
            game.import('character',function(){
                var wushuangsha={
							...
							content:function(){
								for(var i=0;i<trigger.cards.length;i++){
									if(trigger.cards[i].original=='e'){
										if(lib.card[trigger.cards[i].name].skills) player.addTempSkill(lib.card[trigger.cards[i].name].skills,{player:'equipBefore'});
									};
								};
							},
						},
                    ...
                    translate:{
						...
						'WSS_jiushi':'救世',
						'WSS_jiushi_info':'限定技，你死亡时，所有角色回复一点体力',
						'WSS_lvbu':'吕布',
						'WSS_wuxie':'无懈',
