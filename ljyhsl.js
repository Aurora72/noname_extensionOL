window.func=function(lib,game,ui,get,ai,_status){
	game.import('character',function(){
		...
		for(var i in ljyhsl.character){
			if(i.indexOf('drlz')!=-1) ljyhsl.characterSort.ljyhsl['ljyhsl1'].push(i);
			if(i.indexOf('lrfj')!=-1) ljyhsl.characterSort.ljyhsl['ljyhsl2'].push(i);
			if(i.indexOf('nzry')!=-1) ljyhsl.characterSort.ljyhsl['ljyhsl3'].push(i);
			if(i.indexOf('gmrh')!=-1) ljyhsl.characterSort.ljyhsl['ljyhsl4'].push(i);
			if(i.indexOf('hyrs')!=-1) ljyhsl.characterSort.ljyhsl['ljyhsl5'].push(i);
			if(i.indexOf('lyb')!=-1) ljyhsl.characterSort.ljyhsl['ljyhsl6'].push(i);
		};
		return ljyhsl;
	});
