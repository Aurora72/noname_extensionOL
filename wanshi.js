window.func = function (lib, game, ui, get, ai, _status) {
	game.import('character', function (lib, game, ui, get, ai, _status) {
		var wanshi = {
			...
			connect: true,
			character: {
				qws青龙: ["male", "gu", 4, ["ws滔天", "guicai"],
					["des:<li>青龙是古代神话传说中的灵兽，属于传统文化中的四象之一，四象即是青龙、白虎、朱雀、玄武四圣兽。<li>从先秦时代开始它就是代表太昊与东方七宿的神兽，而到了汉代五行学说开始兴起，它的象征含义又多了甲乙与春季<li>《淮南子》卷三 记载：天神之贵者，莫贵于青龙<li>故而青龙或为四象之首。"]
				],
				zws朱雀: ["female", "gu", 4, ["ws赤炎", "ws焚天"],
					["des:<li>朱雀是传统文化中的四象之一，《三辅黄图》所谓的“天之四灵”之一。<li>从殷商时代开始它就是代表炎帝与南方七宿的神兽，而五行学说开始兴起之后，它的象征含义又多了丙丁与夏季。<li>很多人将其认为是凤凰或是凤凰的一种，但实际上朱雀与凤凰存在极大的不同，且作为天之四灵与四方星宿之一的朱雀比礼记四灵之一的凤凰更加尊贵。<li>亓鑫铭所著《泛亚论》称古越国以朱雀为图腾。"]
				],
				xws玄武: ["female", "gu", 4, ["ws忠臣", "ws龟背"],
					["des:<li>玄武是古代神话传说中的灵兽，属于传统文化中的四象之一，四象即是青龙、白虎、朱雀、玄武四圣兽。 <li>从先秦时代开始它就是代表颛顼与北方七宿的神兽，而到了汉代五行学说开始兴起，它的象征含义又多了壬癸与冬季。<li>二十八宿，玄武是北方七宿（斗、牛、女、虚、危、室、壁）的总称。"]
				],
				bws白虎: ["male", "gu", 4, ["ws兽性", "ws虎跃"],
					["des:<li>白虎也是战神、杀伐之神，源于上古星宿崇拜。白虎具有避邪、禳灾、祈丰及惩恶扬善、发财致富、喜结良缘等多种神力。它是四灵之一，当然也是由星宿变成的。是由二十八星宿之中位西方的七宿：奎、娄、胃、昴、毕、觜、参组成。所以是西方的代表，而它的白，是因西方在五行中属金，色是白。所以白色是从五行中说的。 <li>除了道教中的四灵包括青龙白虎之外，连在风水师探勘墓地时，在地形前方左右两边突起的地形，可以当作墓穴的地方，都有独特的称号，称之左青龙、右白虎，取其护卫之意，而在公堂中也有相同的装饰，在左右堂柱上绘有青龙白虎，以其镇压邪灵。而在道教兴起之后，龙虎被借用为道家炼丹的术语，就是指“铅汞、坎离、水火、阴阳”等的同意词。而另外一种说法是，性属木，木代表东方，于卦为震，故比为青龙；情属金，金代表西方，于卦为兑，金白色，故喻为白虎。金能够克木，故情多损性，而用二八之真精气，使之交合为一，则金木无间，龙虎自伏而成丹，在人体中则以肝为龙、肾为虎，而外丹则仍取阴阳之意，以龙为铅，虎为汞。 <li>由于白虎是战伐之神，所以有多位猛将被说成为白虎星转世，如：唐代大将罗成、薛仁贵父子等人。<li>在中国传统文化中是道家西方七宿星君四象之一，根据五行学说，它是代表西方的灵兽，为白的老虎，代表的季节是秋季。 二十八宿的西方七宿（奎、娄、胃、昴、毕、觜、参），其形象虎，位于西方，属金，色白，总称白虎。<li>在中国四圣兽中,另外一个常常跟龙相提并论的就是‘白虎’，跟青龙同样，白虎也非“虎”。 在中国的神话传说中，白虎是战神、杀伐之神。同时，白虎具有避邪、禳灾、祈丰及惩恶的扬善、发财致富、喜结良缘等多种神力。而它是四灵之一，当然也是由星宿变成的。<li>象征 白虎象征着威武和军队，所以古代很多以白虎冠名的地方都与兵家之事有关，例如古代军队里的白虎旗和兵符上的白虎像。 白虎一般出现在汉代画像石墓的墓门上，或与青龙分别作为单独画像刻在墓室的过梁两侧，用以辟邪。<li>《风俗通义》云：“虎者，阳物，百兽之长也，能执搏挫锐，噬食鬼魅。”在汉代五行观念中，白虎被视作西方神兽。"]
				],
				zws烛龙: ["male", "gu", 3, ["ws火烛", "ws苍龙"],
					["des:<li>烛龙，别名烛九阴，中国古代神话中的钟山之神<li>据《山海经》中记载，烛龙也称烛九阴，是人面蛇身的形象，赤红色，身长千里，睁开眼就为白昼，闭上眼则为夜晚，吸气为冬天，呼气为夏天，又能呼风唤雨，不喝水不进食，不睡觉也不休息。"]
				],
				qws麒麟: ["male", "gu", 4, ["ws四象"],
					["des:<li>麒麟，中国传统祥兽，是中国古籍中记载的一种神物，与凤、龟、龙共称为“四灵”，是神的坐骑，古人把麒麟当作仁宠，雄性称麒，雌性称麟。麒麟与貔貅的区别：麒麟是吉祥神宠，主太平、长寿、吉祥。貔貅是凶猛的瑞宠，且护主心特别强，有招财纳福、镇宅避邪的作用，它以财为食，能食四方之财，目前以尚修堂开光貔貅的效果较为明显。民间一般用麒麟主太平长寿，用貔貅来主招财、镇宅、辟邪。麒麟和貔貅因其深厚的文化内涵，在中国传统民俗礼仪中，被制成各种饰物和摆件用于佩戴和安置家中，有祈福和安佑的用意。"]
				],
				hws浑沌: ["male", "gu", 4, ["ws混沌", "ws肆暴"],
					["des:<li>混沌，是古代的凶神。传说它形状肥圆、像火一样通红，长有四只翅膀、六条腿，虽然没有五官，但是却能够通晓歌舞曲乐。还有一种说法称浑沌是象狗或熊一样的动物，人类无法看见它、也无法听见它.<li>它经常咬自己的尾巴并且傻笑；如果遇到高尚的人，浑沌便会大肆施暴；<li>如果遇到恶人，浑沌便会听从他的指挥"]
				],
				tws饕餮: ["male", "gu", 4, ["ws绝戮", "ws暴食"],
					["des:<li>传说轩辕黄帝大战蚩尤，蚩尤被斩，其首落地化为饕餮。<li>《山海经.北山经》有云：“钩吾之山其上多玉，其下多铜。有兽焉，其状如羊身人面，其目在腋下，虎齿人爪，其音如婴儿，名曰狍鸮，是食人。”根据晋代郭璞对《山海经》的注解，这里说的狍鸮即是指饕餮。<li>《神异经.西荒经》中有云：“饕餮，兽名，身如牛，人面，目在腋下，食人。” 后来，饕餮变成了图腾，刻于各种祭祀用的器皿之上。《吕氏春秋.先识览》有云：“周鼎著饕餮，有首无身，食人未咽害及其身，以言报更也。”殷周时代鼎彝上常刻的就是饕餮，其脑袋狰狞，双目炯炯，赫然有神，鼻梁凸出；首部有一双弯曲的兽角或足，其弯曲的方向似无定制，或内勾似羊角，或外曲似牛角；巨嘴大张，利齿如锯，嘴略弯曲内勾，或嘴巴紧锁。则作正面盘踞状，身躯拱起，头着地或水云气，两边有一对利爪，象狗爪或虎爪。两侧有一对肉翅，形如耳朵。 因富贪欲故后世喻贪婪之人为‘饕餮‘。<li>《左传.文公十八年》有云：“缙云氏有不才子，贪于饮食，冒于货贿，天下谓之饕餮。” 饕餮好食，举凡目之所及，无所不食，若天下食尽，则将自食己身；是四大凶兽中物理杀伤力最强的怪兽，传说为三苗氏死后所化，纵使大罗金仙，也难逃饕餮吞噬。"]
				],
				...
				qws穷奇: ["male", "gu", 3, ["ws洪荒"],
					["des:<li>穷奇，中国神话传说中的古代四凶之一，主要记载于《山海经》中，《山海经·海内北经》所载，指穷奇外貌像老虎，长有一双翅膀，喜欢吃人，更会从人的头部开始进食，是一头凶恶的异兽。可是，同样在《山海经》中。<li>《山海经·西山经》一篇却提到穷奇的另一种形象，该篇中的穷奇，外貌像牛，长著刺猬的毛发，与《海内北经》所述者有很大的差别。不过二者都是喜欢食人的凶兽，这方面则没有分别。据说穷奇经常飞到打斗的现场，将有理的一方鼻子咬掉；如果有人犯下恶行，穷奇会捕捉野兽送给他，并且鼓励他多做坏事。古人也把那种不重心意、远君子近小人的人称为穷奇"]
				],
				tws腾蛇: ["male", "gu", 4, ["ws腾空", "ws羽落"],
					["des:<li>螣蛇又称腾蛇，中国民间传说中的一种能飞的蛇，在中国古代文献中有许多这方面的记载，称为“神兽”，有诸多代表意义。 <li>螣蛇一词的典故出于《荀子·劝学》“螣蛇无足而飞，鼯鼠五技而穷”，指螣蛇虽然无足，却比多技的鼯鼠更能腾云驾雾，游走空中，借此比喻凡人做事理当专心一致，最终必能取得成功。<li>《尔雅·释鱼》中亦有提及“螣”即“螣蛇”，东晋郭璞为其作注，指螣蛇为“龙类也，能兴云雾而游其中”。"]
				],
				yws雨师妾: ["female", "gu", 4, ["ws祈雨", "ws蓄精"],
					["des:《山海经·海外东经》：“ 雨师妾在其北，其为人黑，两手各操一蛇，左耳有青蛇，右耳有赤蛇。”"]
				],
				fws风生兽: ["female", "gu", 2, ["ws化风"],
					["des:炎洲在南海中，地方二千里，去北岸九万里。上有风生兽，似豹，青色，大如狸。张网取之，积薪数车以烧之，薪尽而不然，灰中而立，毛亦不燋;斫刺不入，打之如皮囊，以铁锤锻其头数十下乃死，而张口向风，须臾复活"]
				],
			...
			skill: {
				...
				ws蓄精: {
					...
					forced: true,
					filter: function (event, player) {
						return event.parent.name == 'phaseDiscard' && player.num('h', {
							type: 'basic'
						}) < player.num('h');
					},
					content: function () {},
		...
		if (lib.device || lib.node) {
			for (var i in wanshi.character) {
				wanshi.character[i][4].push('ext:扩展ol/' + i + '.jpg');
			}
		}
		else {
			for (var i in wanshi.character) {
				wanshi.character[i][4].push('db:extension-扩展ol:' + i + '.jpg');
			}
		}
		return wanshi;
	});
	lib.group.push('gu');
	lib.translate.gu = '<span style="color:rgba(185,0,0,0.8);font-family:shousha;font-weight:600;">古</span>';
